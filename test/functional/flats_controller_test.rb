...
class FlatsControllerTest < ActionController::TestCase
  ...
  test "should create flat" do
    assert_difference('Flat.count') do
      post :create, flat: { address: @flat.address, bedroom_count: @flat.bedroom_count, latitude: @flat.latitude, longitude: @flat.longitude, name: @flat.name }
    end
  ...
  test "should update flat" do
    put :update, id: @flat, flat: { address: @flat.address, bedroom_count: @flat.bedroom_count, latitude: @flat.latitude, longitude: @flat.longitude, name: @flat.name }
    assert_redirected_to flat_path(assigns(:flat))
  end
